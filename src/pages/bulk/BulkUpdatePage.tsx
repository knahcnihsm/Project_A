...
const SAMPLE_DATA: Record<string, Record<string, string>[]> = {
  student_details: [
    {
      application_no: 'RGCET/2026/9001',
      register_no: '26BTECH901',
      student_name: 'Sample Student One',
      date_of_birth: '2008-05-15',
      aadhaar_no: '987654321901',
      gender: 'Male',
      district: 'Puducherry',
      nationality: 'Indian',
      caste: 'OBC',
      mobile_number: '9840123451',
      email_id: 'sample.student1@example.com',
    },
  ],
  parent_details: [
    {
      application_no: 'RGCET/2026/9001',
      father_name: 'Sample Father One',
      father_mobile_no: '9840123452',
  ...
  address: [
    {
      ...
      address_line: '123 Sample Street, Puducherry',
      pincode: '605001',
      phone: '04132233445',
      mobile: '9840123451',
      email: 'sample.student1@example.com',
  ...
  qualifying_examination: [
    {
      application_no: 'RGCET/2026/9001',
      institution_name: 'Sample Higher Secondary School',
      institution_place: 'Puducherry',
      exam_passed: 'HSC',
      month_year_of_passing: '05/2025',
      sslc_registration_no: 'SSLC123456',
      sslc_percentage: '85',
      hsc_registration_no: 'HSC123456',
      hsc_percentage: '88',
    },
  ],
  diploma_details: [
    {
      application_no: 'RGCET/2026/9002',
      diploma: 'Diploma in Computer Engineering',
      institution_name: 'Sample Polytechnic',
      board: 'DOTE',
      second_year_percentage: '80',
      third_year_percentage: '82',
      aggregate_percentage: '81',
    },
  ],
  pg_qualification: [
    {
      application_no: 'RGCET/2026/9003',
      university_name: 'Sample University',
      university_place: 'Puducherry',
      institution_name: 'Sample Engineering College',
      institution_place: 'Puducherry',
      exam_passed: 'B.E',
      month_year_of_passing: '05/2024',
      total_percentage: '85',
      main_subject_percentage: '88',
      degree_registration_no: 'DEG123456',
    },
  ],
  student_fee: [
    {
